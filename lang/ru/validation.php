...
return [
    ...
    'attributes'           => [
        ...
        'merchant_products'        => 'Товары',
        'merchant_product_id'      => 'ID товара',
        'sale'                     => 'Продажа',
        ...
        'orders'                   => 'Заказы',
        'order_id'                 => 'ID заказа',
        'order_item'               => 'Блюдо заказа',
        'order_items'              => 'Блюда заказа',
        'order_item_id'            => 'ID блюда заказа',
        'plastic_card'             => 'Пластиковая карта',
        'plastic_cards'            => 'Пластиковые карты',
        'plastic_card_id'          => 'ID пластиковой карты',
        'reason'                   => 'Причина',
        'reasons'                  => 'Причины',
        'reason_id'                => 'ID причины',
