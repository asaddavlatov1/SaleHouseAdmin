...
return [
    ...
    "in_active"            => ":food faol emas",
    "not_delete"           => ":food faol emas",
    ...
    "attributes"           => [
        ...
        "enter_password"           => "Yangi parol",
        "confirm_password"         => "Parolni tastiqlang",
        "object"                   => "obekt",
        "warehouse"                => "Omborxona",
        "warehouses"               => "Omborxonalar",
        "merchant_product"         => "Tovar",
        "merchant_products"        => "Tovarlar",
        "merchant_product_id"      => "Tovar ID",
        "sale"                     => "Sotuv",
        "cashbox_name"             => "Kassaning nomi",
        "cashbox"                  => "Kassa",
        "cashboxes"                => "Kassalar",
        "warehouse_name"           => "Omborxona nomi",
        "payment_type"             => "To'lov turi",
        "cashbox_expense"          => "Kassa xarajati",
        'ean'                      => 'shtrix kod',
        'tags'                     => 'Teglar',
        'tag'                      => 'Teg',
        'bunus'                    => 'bonus',
        ...
        'order_item'               => "Buyurtma ovqati",
        'order_items'              => "Buyurtma ovqatlari",
        'order_item_id'            => "Buyurtma ovqati ID",
        'plastic_card'             => "plastik karta",
        'plastic_cards'            => "plastik kartalar",
        'plastic_card_id'          => "plastik karta ID",
        'reason'                   => "Sabab",
        'reasons'                  => "Sabablar",
        'reason_id'                => "Sabab ID",
        'reservation'              => "Bron",
        'reservations'             => "Bronlar",
        'reservation_id'           => "bron ID",
        'restaurant'               => "Restoran",
    ...
    "isNumeric"            => ":Attribute maydoni son bo'lishi kerak",
];
